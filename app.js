...
// Modify the dashboard route to be dynamic
...
// Modify the order-ready route to be dynamic
...
// Modify the generate-otp route to be dynamic
...
// Modify the verify-otp route to be dynamic
...
//             await order.save();
//             res.status(200).send("OTP verified successfully. Order marked as completed.");
//         } else {
...
// Modify the completed-orders API to be dynamic
...
// Modify the create-order API to be dynamic
...
// Modify the clear-cart API to be dynamic
